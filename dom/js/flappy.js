...
function FlappyBird() {
  ...
  this.restart = function () {
    ...
    barreiras = new Barreiras(altura, largura, 200, 400,
      () => progresso.atualizarPontos(++pontos))
...
const click = () => {
  butaum.style.visibility = 'hidden'
  flappy.start()
}

const butaum = document.querySelector('[start-game]')
butaum.onclick = click


const fimDeJogo = () => {
  const fim = document.querySelector('[end-game]')
  fim.style.visibility = 'visible'
  // console.log(butaum);
  // butaum.innerHTML = 'Restart'
  // butaum.style.visibility = 'visible'
